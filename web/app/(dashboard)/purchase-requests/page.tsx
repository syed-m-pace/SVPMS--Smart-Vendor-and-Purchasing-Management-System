...
export default function PurchaseRequestsPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable columns={columns} data={prs} loading={loading} page={page} totalPages={totalPages} onPageChange={setPage} onRowClick={(pr) => router.push(`/purchase-requests/${pr.id}`)} />
        </div>
    );
}
